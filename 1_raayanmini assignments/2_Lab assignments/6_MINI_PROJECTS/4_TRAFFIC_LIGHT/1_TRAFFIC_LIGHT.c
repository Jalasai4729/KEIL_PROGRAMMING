...
unsigned char str[]="TRAFFIC LIGHTS";
unsigned char r[]="RED LED IS ON";
unsigned char r1[]="STOP VEHICLES";

unsigned char g[]="GREEN LED IS ON";
unsigned char g1[]="MOVE VEHICLES";

unsigned char b[]="BUZZER IS ON";
unsigned char s1[]="RED GREEN LED ON";
unsigned char s2[]="WALK PEOPLES";
	...
	while (1)
	{
      ...
      GPIOB_ODR |=(1 << 12); // BUZZER ON
       ...
       km_write_string(s2);
			...
			GPIOB_ODR ^=(1 << 13); // RED LED TOGGLE
			delay(100);
      GPIOB_ODR ^= (1 << 14); // GREEN LED TOGGLE
			delay(100);
      //flaag=0;
		}
  }
