...
unsigned char str1[]="P A N I C ";
unsigned char str2[]="A L A R A M";
unsigned char str3[]="D A N G E R !!";
unsigned char str4[]="RED ALERT";
unsigned char str5[]="HELP ARRIVED";
unsigned char str6[]="GREEN ALERT";
unsigned char str7[]="SAFE ZONE THANK";
unsigned char str8[]=" YOU FOR SAVING";
		...
		if(flag==1)
		{
          ...
          km_write_string(str4);//DORECTION
		      UP++;
			   ...
			   GPIOB_ODR &=~(0x1<<13);//RED LED ON blink
				 delay(100);
		     GPIOB_ODR |=(0x1<<13);
				 delay(100);
