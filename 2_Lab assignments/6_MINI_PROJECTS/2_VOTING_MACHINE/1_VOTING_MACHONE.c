...
unsigned char str1[]="  VOTING ";
unsigned char str2[]="      MACHNE  ";
unsigned char str3[]=" VALID";
unsigned char str4[]="  SAI  ";
unsigned char str5[]=" PRABHAS";
unsigned char str6[]=" ANUDEEP";
unsigned char str7[]=" NOTA ";
unsigned char str8[]="INVALID !!!";
...
//OPERATION PHASE
	...
	// else if((invalid1==1 && invalid2==2) || (invalid1=1 && invalid3==3) ||(invalid2==2 && invalid3==3))
		  else if(flag==5)
	      	{
			        km_write_cmd(0x01);//CLEAR LCD DISPLAY		
			        km_write_cmd(0x80);//CURSOR ON 1st ROW STARTING POSITION
...
void EXTI9_5_IRQHandler(void)
{
	   ...
	   else if(EXTI_PR &(0x1 << 9))
	   {
		 ...
		 else if(EXTI_PR &(0x1<<8) && (EXTI_PR &(0x1<<9)))
		 {
			 flag=5;
			 EXTI_PR |=(0x1 << 8);//CLEAR PR PENDING STATUS REGESTER
			 EXTI_PR |=(0x1 << 9);//CLEAR PR PENDING STATUS REGESTER
