...
unsigned char str1[]="POSSWORD";
unsigned char str2[]="AUTHENTICATION";
unsigned char str3[]="ENTER";

unsigned char str4[]="1";
unsigned char str5[]="0";
unsigned char str6[]="1";
unsigned char str7[]="CORRECT";
unsigned char str8[]="INCORRECT ENTER";
unsigned char str9[]="CORECT PASSWORD";
unsigned char str10[]="WELCOME";
unsigned char str11[]="  ERROR";
	...
	while (1)
	{
		if(flag==1)
		{
          ...
          km_write_string(str4);//DORECTION
			   ...
			   GPIOB_ODR &=~(0x1<<14);//GREEN LED ON blink
				 delay(100);
		     GPIOB_ODR |=(0x1<<14);
				 delay(100);
         GPIOB_ODR |=(0x1<<13);//GREEN LED OFF
             ...
             flag=0;
			        if(p1==p2 && p3==2)
	              		...
	              		//LCD DISPLAY
			               km_write_cmd(0x01);//CLEAR LCD DISPLAY		
			               km_write_cmd(0x80);//CURSOR ON 1st ROW STARTING POSITION
                     km_write_string(str10);//DORECTION
   			             km_write_cmd(0xc0);//CURSOR ON 1st ROW STARTING POSITION
                     km_write_string(str9);//DORECTION
                    ...
                    km_write_string(str8);//DORECTION
   			            km_write_cmd(0xc0);//CURSOR ON 1st ROW STARTING POSITION
                    km_write_string(str11);//DORECTION
